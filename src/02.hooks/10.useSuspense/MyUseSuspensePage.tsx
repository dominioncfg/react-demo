    ...
    return (
        <>
            <div>
                ...
                <input type="number" value={limit} onChange={(e) => setLimite(Number(e.target.value))} />
            </div>
            <Suspense fallback={<p>Loading users...</p>}>
                <UsersTable usersQuery={usersQuery} onUserSelected={handleUserSelected} />
                <Suspense fallback={<p>Loading user...</p>}>
                    <SelectedUserInfo userQuery={selectedUser ? fetchUserById(selectedUser) : null} onUnselect={handleUnselectSelectedUser} />
                </Suspense>
            </Suspense>
        </>
    )
