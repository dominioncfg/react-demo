        ...
        <div>
            ...
            <div>
                <table>
                    ...
                    <tbody>
                        <UserRow name="Without Callback User" onSelected={handleUserSelectedWithoutUseCallback} />
                        <UserRow name="With Callback User" onSelected={handleUserSelectedWithUseCallback} />
                    </tbody>
                </table>
            </div>
