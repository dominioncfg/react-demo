    ...
    <div className="flex flex-col">
        ...
        <div className="bg-linear-to-r from-blue-500 to-blue-900 rounded-lg shadow-lg p-6">
          <div className="flex flex-col gap-2 md:flex-row">
            ...
            <BasicTextButton
              style="blue"
              className="w-20"
              onClick={() => anotherIncreaseBy(5)}
              text="+5"
            />
          </div>
          <div className="text-2xl m-4">
            Another Count:{' '}
            <strong data-testid="anotherCounter">{anotherCounter}</strong>
          </div>
        </div>
      </div>
      <div className="flex flex-row p-8 pb-0 gap-12 justify-center">
        <div className="bg-linear-to-tr from-red-500 to-blue-500 rounded-lg shadow-lg p-6">
          <div className="text-2xl m-4">
            Total Count:{' '}
            <strong className="min-w-8 inline-block" data-testid="total">
              {sum()}
            </strong>
          </div>
      ...
      <div>
        ...
        <img
          className="self-center mt-4 w-full md:w-1/2 rounded-xl h-96 object-fill shadow-lg"
          src={backgroundImage}
          alt="My Backround Image"
        />
      </div>
        ...
        <table className="table-auto w-full border-collapse border border-gray-200 text-sm">
          ...
          <tbody>
            <tr className="odd:bg-white even:bg-gray-50 hover:bg-gray-100">
              <td className="px-6 py-2 border-t border-gray-200 text-gray-600 text-left">
                John Doe
              </td>
              <td className="px-6 py-2 border-t border-gray-200 text-gray-600 text-left">
                john@example.com
