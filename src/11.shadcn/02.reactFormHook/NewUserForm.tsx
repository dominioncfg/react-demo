...
export const NewUserForm = ({ onUserCreatedSuccessfully }: NewUserFormProps) => {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type='number' placeholder="Age" {...field} onChange={(e) => field.onChange(e.target.valueAsNumber)} />
              </FormControl>
              <FormDescription className='text-right'>
                How old is he
              </FormDescription>
